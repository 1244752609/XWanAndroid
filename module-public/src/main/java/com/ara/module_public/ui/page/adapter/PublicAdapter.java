...
import com.ara.module_public.databinding.PubItemPublicBinding;
 ...
 * 搜索列表
 */
public class PublicAdapter extends SimpleAdapter<PubItemPublicBinding, ArticleBean> {
    @Override
    protected void onBindViewHolder(@NonNull ViewHolder<PubItemPublicBinding> holder, int position,
                                    @NonNull PubItemPublicBinding binding, @Nullable ArticleBean data, int checkIndex) {
