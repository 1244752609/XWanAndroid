package com.ara.module_copy.ui.state;

import androidx.lifecycle.MutableLiveData;
import androidx.lifecycle.ViewModel;

import com.ara.module_copy.domain.request.CopyRequest;
 ...
 * <p>
 */
public class CopyMainActivityViewModel extends ViewModel {
    ...
    public final CopyRequest copyRequest = new CopyRequest();
}
