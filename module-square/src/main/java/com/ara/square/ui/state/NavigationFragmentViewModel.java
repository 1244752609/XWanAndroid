...
import com.ara.square.domain.request.SquareRequest;
import com.ara.square.ui.page.adapter.NavigationAdapter;
 ...
 * <p>
 */
public class NavigationFragmentViewModel extends ViewModel {
    ...
    public final SquareRequest squareRequest = new SquareRequest();

    public final NavigationAdapter adapter = new NavigationAdapter();

    public final ObservableArrayList<NavigationBean> data = new ObservableArrayList<>();
