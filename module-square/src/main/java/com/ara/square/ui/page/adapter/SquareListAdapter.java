...
import com.ara.square.databinding.SquItemSquareBinding;
 ...
 * 搜索列表
 */
public class SquareListAdapter extends SimpleAdapter<SquItemSquareBinding, ArticleBean> {
    @Override
    protected void onBindViewHolder(@NonNull ViewHolder<SquItemSquareBinding> holder, int position,
                                    @NonNull SquItemSquareBinding binding, @Nullable ArticleBean data, int checkIndex) {
