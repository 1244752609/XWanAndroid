...
import com.ara.project.databinding.ProItemProjectBinding;
 ...
 * 搜索列表
 */
public class ProjectAdapter extends SimpleAdapter<ProItemProjectBinding, ArticleBean> {
    @Override
    protected void onBindViewHolder(@NonNull ViewHolder<ProItemProjectBinding> holder, int position,
                                    @NonNull ProItemProjectBinding binding, @Nullable ArticleBean data, int checkIndex) {
